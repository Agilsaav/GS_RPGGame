...
#include "GSStackableInventory.generated.h"
 ...
 */
UCLASS()
class GS_RPGGAME_API UGSStackableInventory : public UObject, public IGSInventory
{
	GENERATED_BODY()
...
private:
	TArray<FGSStackableItemData> Items;
};
